...
#SBATCH --output=logs/preprocessing/task_2_%j.out
#SBATCH --error=logs/preprocessing/task_2_%j.err
#
# ===========================================================================
# SLURM Job: Preprocess CICIoMT2024 — Task 2 (Binary Classification)
# ===========================================================================
#
...
echo "Task: 2 (Binary Classification)"
echo "============================================="

# Install required packages if not already present
pip install --user scikit-learn imbalanced-learn pyyaml numpy pandas 2>&1 | tail -1

# --- Run preprocessing for Task 2 only ---
python3 scripts/run_preprocessing.py --dataset CICIoMT2024 --task 2 --verbose --force
