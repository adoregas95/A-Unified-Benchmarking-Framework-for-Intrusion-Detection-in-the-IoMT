...
#SBATCH --output=logs/preprocessing/task_6_%j.out
#SBATCH --error=logs/preprocessing/task_6_%j.err
#
# ===========================================================================
# SLURM Job: Preprocess CICIoMT2024 — Task 6 (6-Class Family Classification)
# ===========================================================================
#
...
echo "Task: 6 (6-Class Family Classification)"
echo "============================================="

# Install required packages if not already present
pip install --user scikit-learn imbalanced-learn pyyaml numpy pandas 2>&1 | tail -1

# --- Run preprocessing for Task 6 only ---
python3 scripts/run_preprocessing.py --dataset CICIoMT2024 --task 6 --verbose --force
